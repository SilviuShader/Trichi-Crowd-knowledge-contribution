...
namespace Crowd_knowledge_contribution.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            var users = from user in _database.Users
        ...
        public ActionResult Show(string id)
        {
            ...
            var userRoleName = (from role in _database.Roles
        ...
        public IEnumerable<SelectListItem> GetAllRoles()
        {
            ...
            var roles = from role in _database.Roles select role;
        ...
        public ActionResult Edit(string id, ApplicationUser newData)
        {
            ...
            try
            {
                ...
                if (TryUpdateModel(user))
                {
                    ...
                    var selectedRole = _database.Roles.Find(HttpContext.Request.Params.Get("newRole"));
        ...
        public ActionResult Delete(string id)
        {
            ...
            var articles = _database.Articles.Where(a => a.UserId == id);
            foreach (var article in articles)
            {
                _database.Articles.Remove(article);

            }
            var comments = _database.Comments.Where(comm => comm.UserId == id);
